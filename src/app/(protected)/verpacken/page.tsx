  ...
  return (
    <div className="max-w-lg space-y-6">
      ...
      <p className="text-sm text-neutral-600">
        ...
        losen Teilen wird reduziert{isShopifyConfigured() ? " und, wenn verknüpft, der Shopify-Bestand der Packung erhöht." : "."}
      </p>
      <VerpackenForm sizes={sizes} shopifyConfigured={isShopifyConfigured()} />
    </div>
  );
}
