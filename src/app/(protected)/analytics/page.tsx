  ...
  return (
    <div className="space-y-10">
      ...
      <div className="space-y-8">
        {forecasts.map((f, i) => (
          <section key={f.sizeId} className="rounded-md border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-5">
            ...
            <div className="mt-5 grid grid-cols-2 gap-4 text-sm sm:grid-cols-4">
              <div>
                <div className="text-neutral-500 dark:text-neutral-400">Bestand gesamt</div>
              ...
              <div>
                <div className="text-neutral-500 dark:text-neutral-400">Ø/Tag (7d / 30d)</div>
                <div className="text-lg font-semibold">
                  {f.rate7.toFixed(1)} / {f.rate30.toFixed(1)}
                </div>
              </div>
              <div>
                <div className="text-neutral-500 dark:text-neutral-400">Bestellpunkt</div>
                <div className="text-lg font-semibold">
                  {Math.round(f.calc.reorderPointUnits)} Stück
                </div>
              </div>
              <div>
                <div className="text-neutral-500 dark:text-neutral-400">Bis Bestellpunkt</div>
                <div className="text-lg font-semibold">
            ...
            <p
              className={`mt-4 rounded-md p-3 text-sm ${
                f.lowConfidence ? "bg-amber-50 dark:bg-amber-950/40 text-amber-900 dark:text-amber-200" : "bg-neutral-50 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300"
              }`}
            >
              {f.reasoning}
            </p>
      ...
      <section>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {packagingForecasts.map((p) => (
            <div key={p.packSize} className="rounded-md border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4">
              <div className="flex items-center justify-between">
              ...
              <p className="mt-2 text-xs text-neutral-500 dark:text-neutral-400">{p.reasoning}</p>
            </div>
          ))}
        </div>
      </section>
